...
# load statements
load('../2019 Electoral Crime/data/candidates.2010.Rda')
load('../2019 Electoral Crime/data/candidates.2012.Rda')
load('../2019 Electoral Crime/data/candidates.2016.Rda')
